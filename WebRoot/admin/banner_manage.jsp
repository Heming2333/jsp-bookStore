    ...
    <nav class="navbar-default navbar-side" role="navigation">
    	<div class="sidebar-collapse">
    		<ul class="nav" id="main-menu">
                ...
                <li>
                	<a href="bsBanner_query.action" class="active-menu waves-effect waves-dark"> 
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <c:forEach items="${sessionScope.bsBannerList }" var="bsBanner"> 
	                                        <tr class="odd gradeX">
	                                            <td class="center">
	                                            	<p>
	                                            ...
	                                            <td class="center">
	                                            	<img src="http://127.0.0.1:8080/book_store/${bsBanner.img}" width="150px" />
	                                            </td>
	                                            <td class="center">
	                                            	${bsBanner.url}
	                                            </td>
