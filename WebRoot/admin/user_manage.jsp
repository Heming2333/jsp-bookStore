    ...
    <nav class="navbar-default navbar-side" role="navigation">
    	<div class="sidebar-collapse">
    		<ul class="nav" id="main-menu">
    			<li>
    				<a href="user_manage.jsp" class="active-menu waves-effect waves-dark">
                ...
                <li>
                	<a href="ta" class="waves-effect waves-dark">
     ...
     <div id="page-wrapper" >
		  <div class="header"> 
            ...
            <footer>
           		<p>Jsp book_store. Writted by: <a href="https://github.com/yuxlan">YuXLan</a></p>
           	</footer>
    	</div>
	</div>
