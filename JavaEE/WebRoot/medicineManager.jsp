    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">医疗管理</strong> / <small>Medicine Manage</small></div>
            </div>
            ...
            <div class="am-g">
                ...
                <!-- End：条件选框，按需增删 -->
                <!-- Start：搜索框，按需增删 -->
                <form action=MedicineManageShowAction.action" method="post">
                <div class="am-u-sm-12 am-u-md-3">
                    <div class="am-input-group am-input-group-sm">
                        <input type="text" name="medicines" class="am-form-field" placeholder="按药品关键字搜索">
                        <span class="am-input-group-btn">
                        <button class="am-btn am-btn-default" type="submit">搜索</button>
                        </span>
                    </div>
          			<div>${errors.medicine[0]}</div>
                </div>
                </form>
                <!-- End：搜索框，按需增删 -->
            </div>
                        ...
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                ...
                                <th class="table-type">联系方式</th>
	                                <th class="table-title">就医时间</th>
	                                <th class="table-type">生病种类</th>
	                                <th class="table-author am-hide-sm-only">所用药物</th>
	                                <th class="table-date am-hide-sm-only">医疗花费</th>
	                                <th class="table-date am-hide-sm-only">就医情况简述</th>
...
<div class="am-modal am-modal-alert" tabindex="-1" id="addNewStudent">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">新增医疗信息<span data-am-modal-close class="am-close">&times;</span></div>
        <div class="am-modal-bd">
		<s:form action="MedicineManageAddAction.action" method="post" theme="simple" class="am-form" id="newStudentForm">
                <!-- 请在placeholder里写该项作用 -->
                ...
                <input name="date" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="就医时间" required>
                <input name="type" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="生病种类" required>
                <input name="medicine" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="所用药物" required>
                <input name="price" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="医疗费用" required>
                <input name="summary" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="病情简述" required>
...
<div class="am-modal am-modal-alert" tabindex="-1" id="modifyStudent">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">更新医疗信息<span data-am-modal-close class="am-close">&times;</span></div>
        <div class="am-modal-bd">
		<s:form action="MedicineManageUpdateAction.action" method="post" theme="simple" class="am-form" id="newStudentForm">
                <!-- 请在placeholder里写该项作用 -->
                <input name="date" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="就医时间" required>
                <input name="type" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="生病种类" required>
                <input name="medicine" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="所用药物" required>
