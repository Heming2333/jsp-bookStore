    ...
    <div class="admin-content">
        <div class="admin-content-body">
            ...
            <div class="am-g">
                ...
                <!-- End：条件选框，按需增删 -->
                <!-- Start：搜索框，按需增删 -->
                <form action="BuildingManageShowAction.action" method="post">
                    ...
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                ...
                                <th class="table-author am-hide-sm-only">楼号</th>
                                <th class="table-date am-hide-sm-only">宿舍号</th>
                                <th class="table-date am-hide-sm-only">床号</th>
                                <th class="table-date am-hide-sm-only">宿舍楼情况简述</th>
                                <th class="table-date am-hide-sm-only">是否为优秀宿舍</th>
...
<div class="am-modal am-modal-alert" tabindex="-1" id="addNewStudent">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">新增宿舍信息<span data-am-modal-close class="am-close">&times;</span></div>
        <div class="am-modal-bd">
		<s:form action="BuildingManageAddAction.action" method="post" theme="simple" class="am-form" id="newStudentForm">
                <!-- 请在placeholder里写该项作用 -->
                ...
                <input name="bno" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="楼号" required>
                <input name="dno" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="宿舍号" required>
                <input name="sbed" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="床号" required>
                <input name="bintro" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="宿舍简介" required>
                <input name="dgood" type="text" class="am-form-field am-radius" id="newStudentId" placeholder="是否为优秀宿舍" required>
...
<div class="am-modal am-modal-alert" tabindex="-1" id="modifyStudent">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">更新宿舍信息<span data-am-modal-close class="am-close">&times;</span></div>
        <div class="am-modal-bd">
		<s:form action="BuildingManageUpdateAction.action" method="post" theme="simple" class="am-form" id="newStudentForm">
                <!-- 请在placeholder里写该项作用 -->
                <input name='sbed' type="text" class="am-form-field am-radius" id="newStudentId" placeholder="床号" required/>
                <input name='dno' type="text" class="am-form-field am-radius" id="newStudentId" placeholder="宿舍号" required/>
                <input name='dgood' type="text" class="am-form-field am-radius" id="newStudentId" placeholder="是否为优秀宿舍" required/>
